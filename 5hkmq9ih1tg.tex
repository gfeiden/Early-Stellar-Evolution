...
\end{itemize}
As with all definitions, there are some ambiguities, particularly for stars with masses in the range of 0.28 $M_{\odot}$ and 0.35 $M_{\odot}$. Stars in this mass range typically develop a rdd